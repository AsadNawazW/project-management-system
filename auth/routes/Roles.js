...
module.exports = (app) => {
  app.get(
    '/roles',
    [validateAuth('roles.index'), listRolesValidate, validateRequest],
    listRolesResponse,
  );
  app.get(
    '/roles/:roleId',
    [validateAuth('roles.get'), getRoleValidate, validateRequest],
    getRoleResponse,
  );
  app.post(
    '/roles',
    [validateAuth('roles.create'), createRoleValidate, validateRequest],
    createRoleResponse,
  );
  app.patch(
    '/roles/:roleId',
